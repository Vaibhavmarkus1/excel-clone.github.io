...
$(".menu-selector").change(function(e){
    ...
    //   cellData[selectedSheet][rowId-1][colId-1]=value;
    // });
...
function addSheetTabEventListeners(){
    ...
    $(".sheet-delete").click(function(){
          ...
          <div class="sheet-delete-modal">
              ...
              <div class="sheet-modal-confirmation">
                  <div class="button delete-button material-icons delete-icon">delete </div>
                  <div class="button cancel-button">Cancel</div>
              </div>
          </div>
      </div>`;
...
$(".new").click(function(e){
    if(saved){
        ...
        let confmodal=$(`<div class="sheet-modal-parent">
        <div class="sheet-delete-modal">
            <div class="sheet-modal-title">
...
function saveFile(createNewFile){
    ...
    $(".ok-button").click(function(e){
        ...
        if(fileName){
            ...
            $(".container").append(a);
            a[0].click(); //jquery wala not kam kar rha hai 
            a.remove();
            $(".sheet-modal-parent").remove();
            saved=true;
        }
